...
type File struct {
	...
	DomainName string    `gorm:"column:domain_name;type:varchar(255);not null" json:"domain_name"`
	BizName    string    `gorm:"column:biz_name;type:varchar(255);not null" json:"biz_name"`
	Hash       string    `gorm:"column:hash;type:varchar(255);not null;index:hash_idx,priority:1" json:"hash"`
	FileSize   int64     `gorm:"column:file_size;type:bigint(20);not null" json:"file_size"`
