...
type ShortVideoCoreVideoServiceClient interface {
	...
	ListPublishedVideo(ctx context.Context, in *ListPublisedVideoRequest, opts ...grpc.CallOption) (*ListPublisedVideoResponse, error)
}
...
func (c *shortVideoCoreVideoServiceClient) FeedShortVideo(ctx context.Context, in *FeedShortVideoRequest, opts ...grpc.CallOption) (*FeedShortVideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ShortVideoCoreVideoService/FeedShortVideo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortVideoCoreVideoServiceClient) GetVideoById(ctx context.Context, in *GetVideoByIdRequest, opts ...grpc.CallOption) (*GetVideoByIdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ShortVideoCoreVideoService/GetVideoById", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortVideoCoreVideoServiceClient) PublishVideo(ctx context.Context, in *PublishVideoRequest, opts ...grpc.CallOption) (*PublishVideoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/api.ShortVideoCoreVideoService/PublishVideo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *shortVideoCoreVideoServiceClient) ListPublishedVideo(ctx context.Context, in *ListPublisedVideoRequest, opts ...grpc.CallOption) (*ListPublisedVideoResponse, error) {
	out := new(ListPublisedVideoResponse)
	err := c.cc.Invoke(ctx, "/api.ShortVideoCoreVideoService/ListPublishedVideo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ShortVideoCoreVideoServiceServer interface {
	...
	ListPublishedVideo(context.Context, *ListPublisedVideoRequest) (*ListPublisedVideoResponse, error)
...
func (UnimplementedShortVideoCoreVideoServiceServer) ListPublishedVideo(context.Context, *ListPublisedVideoRequest) (*ListPublisedVideoResponse, error) {
...
func _ShortVideoCoreVideoService_FeedShortVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ShortVideoCoreVideoService/FeedShortVideo",
	}
...
func _ShortVideoCoreVideoService_GetVideoById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ShortVideoCoreVideoService/GetVideoById",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortVideoCoreVideoService_PublishVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ShortVideoCoreVideoService/PublishVideo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShortVideoCoreVideoService_ListPublishedVideo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListPublisedVideoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ShortVideoCoreVideoService/ListPublishedVideo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortVideoCoreVideoServiceServer).ListPublishedVideo(ctx, req.(*ListPublisedVideoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShortVideoCoreVideoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.ShortVideoCoreVideoService",
