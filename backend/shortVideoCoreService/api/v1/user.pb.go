...
var file_v1_user_proto_rawDesc = []byte{
	...
	0x69, 0x74, 0x65, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8d, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65,
	...
	0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x69, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61,
	...
	0x72, 0x49, 0x64, 0x22, 0x4c, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	...
	0x64, 0x22, 0x89, 0x01, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
	...
	0x04, 0x6d, 0x65, 0x74, 0x61, 0x12, 0x36, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x73, 0x68, 0x6f, 0x72, 0x74, 0x56, 0x69, 0x64, 0x65, 0x6f,
	0x43, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x61, 0x70, 0x69, 0x2e,
	0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x22, 0xb9, 0x01,
	...
	0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x52, 0x04, 0x6d, 0x65, 0x74, 0x61, 0x32,
	0xb3, 0x03, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x84, 0x01, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x2f,
	...
	0x31, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x12, 0x89, 0x01, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x66, 0x6f, 0x12, 0x90, 0x01, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x2f, 0x75, 0x73, 0x65, 0x72, 0x42, 0x47, 0x5a, 0x45, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x7a, 0x65, 0x6e, 0x69, 0x74, 0x68, 0x2f,
	0x44, 0x6f, 0x75, 0x54, 0x6f, 0x6b, 0x2f, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x2f, 0x73,
	0x68, 0x6f, 0x72, 0x74, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x43, 0x6f, 0x72, 0x65, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31, 0x62, 0x06,
...
var file_v1_user_proto_goTypes = []any{
	...
	(*CreateUserRequest)(nil),      // 1: shortVideoCoreService.api.v1.CreateUserRequest
	(*CreateUserResponse)(nil),     // 2: shortVideoCoreService.api.v1.CreateUserResponse
	(*GetUserInfoRequest)(nil),     // 3: shortVideoCoreService.api.v1.GetUserInfoRequest
	(*GetUserInfoResponse)(nil),    // 4: shortVideoCoreService.api.v1.GetUserInfoResponse
	(*UpdateUserInfoRequest)(nil),  // 5: shortVideoCoreService.api.v1.UpdateUserInfoRequest
	(*UpdateUserInfoResponse)(nil), // 6: shortVideoCoreService.api.v1.UpdateUserInfoResponse
	(*Metadata)(nil),               // 7: shortVideoCoreService.api.v1.Metadata
}
var file_v1_user_proto_depIdxs = []int32{
	7, // 0: shortVideoCoreService.api.v1.CreateUserResponse.meta:type_name -> shortVideoCoreService.api.v1.Metadata
	7, // 1: shortVideoCoreService.api.v1.GetUserInfoResponse.meta:type_name -> shortVideoCoreService.api.v1.Metadata
	0, // 2: shortVideoCoreService.api.v1.GetUserInfoResponse.user:type_name -> shortVideoCoreService.api.v1.User
	7, // 3: shortVideoCoreService.api.v1.UpdateUserInfoResponse.meta:type_name -> shortVideoCoreService.api.v1.Metadata
	1, // 4: shortVideoCoreService.api.v1.UserService.CreateUser:input_type -> shortVideoCoreService.api.v1.CreateUserRequest
	3, // 5: shortVideoCoreService.api.v1.UserService.GetUserInfo:input_type -> shortVideoCoreService.api.v1.GetUserInfoRequest
	5, // 6: shortVideoCoreService.api.v1.UserService.UpdateUserInfo:input_type -> shortVideoCoreService.api.v1.UpdateUserInfoRequest
	2, // 7: shortVideoCoreService.api.v1.UserService.CreateUser:output_type -> shortVideoCoreService.api.v1.CreateUserResponse
	4, // 8: shortVideoCoreService.api.v1.UserService.GetUserInfo:output_type -> shortVideoCoreService.api.v1.GetUserInfoResponse
	6, // 9: shortVideoCoreService.api.v1.UserService.UpdateUserInfo:output_type -> shortVideoCoreService.api.v1.UpdateUserInfoResponse
