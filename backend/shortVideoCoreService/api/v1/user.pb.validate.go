...
// Validate checks the field values on UpdateUserImageRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateUserImageRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateUserImageRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateUserImageRequestMultiError, or nil if none found.
func (m *UpdateUserImageRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateUserImageRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return UpdateUserImageRequestMultiError(errors)
	}

	return nil
}

// UpdateUserImageRequestMultiError is an error wrapping multiple validation
// errors returned by UpdateUserImageRequest.ValidateAll() if the designated
// constraints aren't met.
type UpdateUserImageRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateUserImageRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateUserImageRequestMultiError) AllErrors() []error { return m }

// UpdateUserImageRequestValidationError is the validation error returned by
// UpdateUserImageRequest.Validate if the designated constraints aren't met.
type UpdateUserImageRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateUserImageRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateUserImageRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateUserImageRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateUserImageRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateUserImageRequestValidationError) ErrorName() string {
	return "UpdateUserImageRequestValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateUserImageRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateUserImageRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateUserImageRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateUserImageRequestValidationError{}

// Validate checks the field values on UpdateUserImageResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *UpdateUserImageResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UpdateUserImageResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// UpdateUserImageResponseMultiError, or nil if none found.
func (m *UpdateUserImageResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *UpdateUserImageResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UpdateUserImageResponseValidationError{
					field:  "Meta",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UpdateUserImageResponseValidationError{
				field:  "Meta",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UpdateUserImageResponseMultiError(errors)
	}

	return nil
}

// UpdateUserImageResponseMultiError is an error wrapping multiple validation
// errors returned by UpdateUserImageResponse.ValidateAll() if the designated
// constraints aren't met.
type UpdateUserImageResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UpdateUserImageResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UpdateUserImageResponseMultiError) AllErrors() []error { return m }

// UpdateUserImageResponseValidationError is the validation error returned by
// UpdateUserImageResponse.Validate if the designated constraints aren't met.
type UpdateUserImageResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UpdateUserImageResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UpdateUserImageResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UpdateUserImageResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UpdateUserImageResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UpdateUserImageResponseValidationError) ErrorName() string {
	return "UpdateUserImageResponseValidationError"
}

// Error satisfies the builtin error interface
func (e UpdateUserImageResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sUpdateUserImageResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = UpdateUserImageResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = UpdateUserImageResponseValidationError{}
